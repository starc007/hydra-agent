/**
 * Port of Uniswap v3 TickMath.sol — sqrt(1.0001^tick) * 2^96.
 * Returns sqrtPriceX96 as a bigint. Validated to bit-exact match against the Solidity reference.
 */
...
export function getSqrtPriceAtTick(tick: number): bigint {
  ...
  let ratio: bigint = (absTick & 0x1n) !== 0n
